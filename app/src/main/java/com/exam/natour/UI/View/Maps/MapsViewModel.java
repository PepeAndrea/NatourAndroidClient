...
public class MapsViewModel extends ViewModel{
    ...
    public void saveRecordedPath(Context context) {
        ...
        if (newPath != null){
            if (LiveRecordingData.getInstance().getCoordinates() != null){
                newPath.setLocation(this.getPathCityName(context,Double.valueOf(LiveRecordingData.getInstance().getCoordinates().get(0).getLatitude()),Double.valueOf(LiveRecordingData.getInstance().getCoordinates().get(0).getLongitude())));
            }
    ...
    public void saveManualPathRecording(Context context){
        PathDetail newPath = createdPath.getValue();
        if (newPath != null){
            if (LiveRecordingData.getInstance().getCoordinates() != null){
                newPath.setLocation(this.getPathCityName(context,Double.valueOf(LiveRecordingData.getInstance().getCoordinates().get(0).getLatitude()),Double.valueOf(LiveRecordingData.getInstance().getCoordinates().get(0).getLongitude())));
    ...
    private String getPathCityName(Context context, Double latitude, Double longitude){
